...
iterateur=iterateur+m;

% a gauche 
for i=1:m
    for j=1:n 
        A(iterateur+i*j,i*j)=1;
        A(iterateur+i*j,n*m+i*j)=-MM(i); %n*m pour passer aux y
        b(iterateur+i*j)=0;
    end     
end
...
for i=1:m
    for j=1:n 
        A(iterateur+i*j,i*j)=-1;
        A(iterateur+i*j,n*m+i*j)=mm_(i,j); 
        b(iterateur+i*j)=0;
    end     
end
...
for i=1:m
    for j=1:n 
        A(iterateur+i*j,n*m+i*j)=-1; % condition superieur
        b(iterateur+i*j)=0;
    end     
end
...
for i=1:m
    for j=1:n 
        A(iterateur+i*j,n*m+i*j)=1; %condition inferieur
        b(iterateur+i*j)=1;
    end     
end
